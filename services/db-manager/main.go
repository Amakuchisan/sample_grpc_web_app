...
import (
	...
	"github.com/Amakuchisan/sample_grpc_web_app/services/db-manager/config"
	"github.com/Amakuchisan/sample_grpc_web_app/services/db-manager/db"
	server "github.com/Amakuchisan/sample_grpc_web_app/services/db-manager/grpc"
	"github.com/Amakuchisan/sample_grpc_web_app/services/db-manager/log"
...
func run(args []string) error {
	...
	pb.RegisterPictureServer(s, svr)
